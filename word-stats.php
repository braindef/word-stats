...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<p>
			...
			<input type="checkbox" name="word_stats_averages" value="1" <?php if ( $opt_averages ) { ?>checked="checked"<?php } echo ' '; ?>/>
			<?php _e( 'Enable live character/word/sentence averages.', 'word-stats' ); ?> 
		</p>
